  ...
  return (0, import_react.createElement)(
    ...
    (generating || phase === "queued") && (showStop || showRestart) ? (0, import_react.createElement)(
      ...
      (0, import_react.createElement)(
        "div",
        { style: { marginTop: "8px" } },
        phase === "queued" ? (0, import_react.createElement)("button", { type: "button", style: BTN, onClick: () => {
          setPhase("idle");
          setNote("");
        } }, T.cancelQueue) : (0, import_react.createElement)("button", { type: "button", style: BTN_PRIMARY, onClick: () => {
          setPhase("queued");
