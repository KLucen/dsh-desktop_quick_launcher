...
${T.toastWarn}${info.warning}`);
  ...
  const shortcutKnown = status?.shortcut !== void 0;
  ...
  return (0, import_react.createElement)(
    ...
    detailsOpen ? (0, import_react.createElement)(
      ...
      status === null ? (0, import_react.createElement)("div", { style: MUTED }, T.noData) : (0, import_react.createElement)(
        "div",
        null,
        versionSkew ? (0, import_react.createElement)(
          "div",
          { style: { color: "#E5C07B", marginBottom: "8px" } },
...
${T.versionSkewBody}`
        ...
        (0, import_react.createElement)("div", { style: SECTION_TITLE }, T.shortcutTitle),
        (0, import_react.createElement)(
          "div",
          { style: shortcutKnown && shortcutExists ? MUTED : { color: "#E5C07B" } },
        ...
        (0, import_react.createElement)("pre", { style: MONO }, status.shortcut?.path ?? ""),
...
function LauncherSettingsSection() {
  ...
  const [shortcut, setShortcut] = (0, import_react.useState)({ path: "", known: false, exists: false });
  const [skew, setSkew] = (0, import_react.useState)("");
  ...
  const createShortcut = async () => {
    ...
    try {
      ...
      const info = result.body.result ?? {};
      setLastAction(info.warning === void 0 ? `${T.toastOk}${info.path ?? ""}` : `${T.toastWarn}${info.warning}`);
      await loadOptions();
    } catch (error) {
  ...
  return (0, import_react.createElement)(
    ...
    skew === "" ? null : (0, import_react.createElement)(
      "div",
      { style: { color: "#E5C07B", marginBottom: "8px" } },
...
${T.versionSkewBody}`
    ...
    (0, import_react.createElement)(
      "div",
      { style: shortcut.known && shortcut.exists ? MUTED : { color: "#E5C07B" } },
    ...
    shortcut.path === "" ? null : (0, import_react.createElement)("pre", { style: MONO }, shortcut.path),
