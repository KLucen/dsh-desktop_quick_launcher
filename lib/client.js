...
${T.toastWarn}${info.warning}`);
  ...
  return (0, import_react.createElement)(
    ...
    (generating || phase === "queued") && (showStop || showRestart) ? (0, import_react.createElement)(
      "div",
      { style: INLINE_NOTE },
      (0, import_react.createElement)("div", null, `${T.busyBlocked}: ${openTurns.length || "?"}${busyKnown ? "" : `（${T.busyUnknown}）`}`),
      (0, import_react.createElement)("div", { style: { ...MUTED, marginTop: "4px" } }, T.busyHint),
      (0, import_react.createElement)(
        "div",
        { style: { marginTop: "8px" } },
        phase === "queued" ? (0, import_react.createElement)("button", { style: BTN, onClick: () => {
          setPhase("idle");
          setNote("");
        } }, T.cancelQueue) : (0, import_react.createElement)("button", { style: BTN_PRIMARY, onClick: () => {
          setPhase("queued");
          setNote(T.restartQueued);
        } }, T.restartQueued)
      )
    ) : null,
...
function LauncherSettingsSection(props) {
  const { scope } = props;
  const [section, setSection] = (0, import_react.useState)(() => scope.getSnapshot().value ?? {});
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("button", { style: SMALL_BTN, onClick: () => {
        void refreshLogs();
      } }, T.refresh),
      (0, import_react.createElement)("button", { style: SMALL_BTN, onClick: () => {
        void openDir();
      } }, T.openDir),
      (0, import_react.createElement)("button", { style: SMALL_BTN, disabled: working, onClick: () => {
        void clearLogs([]);
      } }, T.clearAll)
    ),
    (0, import_react.createElement)(
      ...
      files.length === 0 ? (0, import_react.createElement)("div", { style: MUTED }, T.noData) : files.map((file) => (0, import_react.createElement)(
        ...
        (0, import_react.createElement)("button", { style: SMALL_BTN, disabled: !file.exists, onClick: () => {
          void viewLog(file.name);
        } }, T.view),
        (0, import_react.createElement)("button", { style: SMALL_BTN, disabled: !file.exists || working, onClick: () => {
    ...
    writable ? null : (0, import_react.createElement)("div", { style: { marginTop: "8px", color: "#E5C07B" } }, T.notWritable)
  );
}
