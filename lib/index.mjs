...
//#endregion
export { Config, LAUNCHER_API, NONCE_HEADER, OPTION_FIELDS, PLUGIN_VERSION, apply, createDesktopShortcut, findOpenTurns, formatDuration, inject, isLauncherFailure, name, parseStatusFile, phaseSeverity, portFromUrl, renderLauncherScript, renderRestartHelper, renderScheduledTaskCommand, resolveLauncherSpec, stripBom, tailLines };
