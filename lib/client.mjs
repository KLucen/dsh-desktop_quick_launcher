...
function PowerGlyph() {
	return createElement("svg", {
		...
		strokeWidth: 2,
		strokeLinecap: "round"
	}, createElement("path", { d: "M12 2v10" }), createElement("path", { d: "M18.4 6.6a9 9 0 1 1-12.8 0" }));
}
function IconGlyph() {
	return createElement("svg", {
		width: 18,
...
function FloatingControl() {
	...
	return createElement("div", null, toast === null ? null : createElement("div", { style: toast.kind === "err" || toast.kind === "warn" ? {
		...TOAST,
		borderColor: "#E54D4D66"
	} : TOAST }, toast.text), createElement("div", { style: {
		position: "fixed",
		right: "18px",
		bottom: "18px",
		zIndex: 2147483e3,
	...
	}, createElement(IconGlyph)), createElement("button", {
		style: {
			...ROUND_BTN,
			background: "#E54D4D"
		},
	...
	}, createElement(PowerGlyph))), !confirmOpen ? null : createElement("div", {
		style: OVERLAY,
		onClick: () => {
		...
		fontWeight: 600,
		fontSize: "15px"
	} }, T.confirmHead), createElement("p", { style: {
		margin: "8px 0 0",
		color: "#9BA1B0",
		fontSize: "13px"
	} }, T.confirmBody), error !== "" ? createElement("p", { style: {
		margin: "10px 0 0",
		color: "#E54D4D",
		fontSize: "12px"
	} }, error) : null, phase === "sent" ? createElement("p", { style: {
		margin: "12px 0 0",
		color: "#7BC96F"
	} }, T.exitSent) : null, createElement("div", { style: DIALOG_ACTIONS }, createElement("button", {
		style: BTN,
		onClick: () => {
			if (!busy) setConfirmOpen(false);
		},
		disabled: busy
	}, T.cancel), createElement("button", {
		style: BTN_DANGER,
		onClick: () => {
			onConfirmStop();
		},
...
function apply(_ctx) {
	...
	createRoot(host).render(createElement(FloatingControl));
}
var client_default = {
	name,
	inject,
